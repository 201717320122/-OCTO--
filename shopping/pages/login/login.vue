...
<script>
	...
	export default{
		...
		methods: {
			...
			async toLogin(){
				let number = {username:this.addressData.username,password:this.addressData.password,loginWay:0}
				console.log(this.addressData.username)
				console.log(this.addressData.password)
				await this.$store.dispatch('login/GetLogin',number);	
